...
void pressure_comm(double **P, int il, int ir , int jb, int jt, int rank_l, int rank_r, int rank_t, int rank_b, double *bufSend, double* bufRecv, MPI_Status *status, int chunk);
